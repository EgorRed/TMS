...
namespace CalculatorTMS
{
    public class Tokenizer
    {
        ...
        {
            // если встречаем в вырожжении пробел и в _valueTokenBuilder есть данные, создаём токен из дынных в _valueTokenBuilder
            // чистим _valueTokenBuilder и по новой искать токины
        ...
        {
            //пытаемся спарсить полученую нечистоту, если всё успешно создаём токен - операнд
            if (double.TryParse(
                raw,
                NumberStyles.Number,
